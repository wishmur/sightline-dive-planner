    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <header className="theme-deep pt-36 pb-16 lg:pt-40 lg:pb-20">
        ...
        >
          ...
          <p className="eyebrow mt-6 text-primary">About Sightline</p>
      ...
      <div className="theme-light">
        <div className="page-frame space-y-16 py-16 lg:space-y-20 lg:py-20">
          {/* HOW IT WORKS */}
            ...
            {EXAMPLE && (
              <figure className={`${CARD} mt-4 grid gap-6 lg:grid-cols-2 lg:gap-10`}>
                <div>
                  ...
                  <p className="mt-1.5 text-[11px] text-muted-foreground">{EXAMPLE.claim.label}</p>
                </div>
                <figcaption className="text-sm leading-relaxed text-muted-foreground lg:border-l lg:border-border lg:pl-10">
                  ...
                  each of {CONCERNS.length} common worries, Sightline looks for the words the notes
                  actually use: crossings, swell and surf launches for seasickness; thermoclines and
                  suit thickness for the cold. A question you type is matched against one
                  destination's sentences the same way, or by the language model where it's switched
                  on.
                </figcaption>
              </figure>
            )}
          ...
          <section id="how-its-checked" className="scroll-mt-20">
            <SectionHeader
              eyebrow="How it's checked"
              title="Checked against its sources, and against tests"
            >
              <p>
                Every claim keeps the sources it came from. Key claims are checked against the exact
                passage, and the quote and date sit next to the claim. Where sources disagree, both
                sides stay visible; where evidence is thin, the claim says so. When a source
                changes, the checks that rest on it come up for review.
              </p>
              <p>
                The logic is tested the same way: against test cases written before the code, and
                scored on cases it was never tuned on. These are results on test cases, not figures
            ...
            <div className={`${CARD} mt-8 lg:p-8`}>
              <div className="max-w-3xl space-y-3 text-base leading-relaxed text-muted-foreground">
                <p>
                  ...
                  operator sites, research papers, forums and word of mouth. I've logged 115+ dives
                  across several regions, PADI Advanced with Nitrox, including plenty of deep,
                  drift, wreck and night diving. This is the reference I wanted for myself.
                </p>
                <p>
                  Been somewhere listed here, spotted something out of date, or want a destination
                  added? Tell me. New information is checked against reliable sources before
                  anything changes.
                </p>
              </div>
